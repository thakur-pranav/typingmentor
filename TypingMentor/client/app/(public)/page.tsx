...
const FEATURES = [
  { title: "Timed & passage modes", body: "Race the clock in 15–120s sprints, or complete a full passage at your own pace.", accent: "yellow" as const },
  { title: "Real-time accuracy", body: "Every keystroke counts — even ones you backspaced. Accuracy is honest here.", accent: "cyan" as const },
  { title: "Track your history", body: "Every saved test is logged so you can see your progress over time.", accent: "pink" as const },
  { title: "Global leaderboard", body: "Compare your best WPM against typists from around the world.", accent: "green" as const },
];
