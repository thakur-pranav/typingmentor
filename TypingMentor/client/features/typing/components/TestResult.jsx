  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-5">
        <SecStat label="Net WPM"   value={result.netWpm}                     />
...
function WpmGraph({ wpmHistory }) {
  ...
  function gx(i) { return PAD.left + (i / Math.max(n - 1, 1)) * iw; }
  function gy(v) { return PAD.top  + ih - (v / maxWpm) * ih; }
  ...
  const pts = wpmHistory.map((w, i) => [gx(i), gy(w)]);
